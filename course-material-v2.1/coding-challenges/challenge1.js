...
IMPORTANT: The ** operator is not supported in this editor. Please make sure to 
use exactly this formula mass / (height * height), and 
not this one mass / (height ** 2).
*/
...
console.log(`Is Mark's BMI is greater than John's: ${markHigherBMI}`);